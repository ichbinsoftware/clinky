...
export const MODE_PALETTES = {
  marko:         ['#efb440','#98a534','#729539','#568789','#465e54','#bfad89','#a9522e','#7f381d'],
  splatter:      ['#f0b6ad','#dc8864','#ba4848','#c75a1b','#f7c435','#818b2e','#0b5227','#85a993'],
  ink:           ['#ffffff','#dddede','#bebfbe','#9f9f9f','#7f8080','#606161','#404241','#212322'],
  concrete:      ['#6f1926','#de324c','#f4895f','#f8e16f','#95cf92','#369acc','#9656a2','#cbabd1'],
  mycelium:      ['#711415','#ae311e','#f37324','#f6a020','#f8cc1b','#b5be2f','#72b043','#007f4e'],
  galaxy:        ['#ebb0d8','#db73be','#c2008b','#8c0083','#6b0099','#543399','#3c6599','#3d7d8f'],
  constellation: ['#e8eef1','#bfdff1','#abd7f1','#96cff1','#6dc0f1','#43b0f1','#057dcd','#1e3d58'],
  gravity:       ['#023641','#034452','#035162','#036b82','#528279','#8e9373','#a19870','#cfd4b8'],
  antmin:        ['#58508d','#bc5090','#ff6361','#ffa600','#ffbd40','#e0d375','#c0e9aa','#80ffd3'],
  conway:        ['#2dd2c0','#00ffba','#fac55b','#fc8484','#ffa05f','#dd8f68','#ef7098','#014263'],
  bounce:        ['#f5f0df','#f3e4bf','#f1d9a1','#efce82','#eec364','#ecb846','#eaad28','#e8a20a'],
  tracer:        ['#d994f4','#d781d5','#d56eb7','#d35b98','#d14879','#cf355b','#cd213c','#cb0e1d'],
  snowfall:      ['#ffadad','#ffd6a5','#fdffb6','#caffbf','#9bf6ff','#a0c4ff','#bdb2ff','#ffc6ff'],
  loop:          ['#de3030','#e07a34','#e2c337','#9dbd3d','#40d6cf','#3d9dbd','#ab567e','#db2b7d'],
  luminaria:     ['#274001','#828a00','#f29f05','#f25c05','#d6568c','#4d8584','#a62f03','#400d01'],
  sequencer:     ['#e9162d','#f28200','#ffdb28','#1fb819','#00e1da','#007bd8','#8f2be7','#fb4fd9'],
  loom:          ['#f83e8b','#f9677a','#f98663','#f8a140','#e8b851','#c7c98b','#9ed8b9','#5fe4e4'],
  subway:        ['#900c3f','#182b55','#5f4e94','#a291c7','#82cbec','#d94f21','#febd2b','#9aab4b'],
  clockwork:     ['#f3c7fc','#d4b4f0','#b6a1e5','#978ed9','#797bce','#5a68c2','#3c55b6','#1d42ab'],
  city:          ['#993f00','#c67e30','#f1bd58','#f9e098','#eef2d8','#ccedf0','#7cbfc6','#00929c'],
  attention:     ['#08d1ca','#19b6cc','#2b9bce','#3c80d0','#4e66d2','#5f4bd4','#7030d6','#8215d8'],
  dendrogram:    ['#0f6385','#358292','#88aca2','#ecd9af','#d6a379','#a77c65','#745644','#573d31'],
  waveform:      ['#351729','#50223d','#76325a','#a5467e','#bc5090','#cd7cac','#dea8c8','#efd4e4'],
  chord:         ['#003f5c','#2c4875','#58508d','#bc5090','#de5a79','#ff6361','#ff8531','#ffa600'],
  mindmap:       ['#de3030','#e07a34','#e2c337','#9dbd3d','#40d6cf','#3d9dbd','#ab567e','#db2b7d'],
  stickies:      ['#fb7b77','#fdc170','#f3f87f','#98f786','#69ebfc','#6d9efc','#937df8','#f78ef0'],
  swot:          ['#6f1926','#de324c','#f4895f','#f8e16f','#95cf92','#369acc','#9656a2','#cbabd1'],
  fishbone:      ['#e3895e','#efbb8e','#f8e1b2','#fbedbe','#dabf90','#b48c5c','#cca467','#e4bc72'],
  pyramid:       ['#682b69','#8e4f96','#a86498','#994454','#a15656','#ab805c','#bdba73','#e6e28a'],
  matrix:        ['#274a57','#4e5672','#71618e','#946aab','#af7bbb','#c192bd','#d4a9bd','#e7c0bd'],
  journey:       ['#f83e8b','#f9677a','#f98663','#f8a140','#e8b851','#c7c98b','#9ed8b9','#5fe4e4'],
};
export const DEFAULT_COLORS = ['#e63946','#f4845f','#457b9d','#2a9d8f','#1d3557','#6c757d','#e9c46a','#d4a373'];
